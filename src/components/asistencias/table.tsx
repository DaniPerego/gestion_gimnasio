                ...
                <div className="flex items-center justify-between border-b dark:border-gray-600 pb-4">
                  <div>
                    <div className="mb-2 flex items-center">
                      <p className="text-gray-900 dark:text-gray-100">{asistencia.socio?.nombre} {asistencia.socio?.apellido}</p>
                    </div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{asistencia.socio?.dni}</p>
                  </div>
          ...
          <table className="hidden min-w-full text-gray-900 dark:text-gray-100 md:table">
            ...
            <tbody className="bg-white dark:bg-gray-700">
              {asistencias?.map((asistencia) => (
                <tr
                  key={asistencia.id}
                  className="w-full border-b border-gray-200 dark:border-gray-600 py-3 text-sm last-of-type:border-none hover:bg-gray-50 dark:hover:bg-gray-600"
                >
